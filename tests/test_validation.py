...
from trashpandas.validation import validate_table_name, validate_schema_name
...
class TestTableNameValidation:
    ...
    def test_sql_injection_characters(self):
        ...
        for name in dangerous_names:
            ...
            # Should raise ValidationError (either from character validation or SQL injection check)
