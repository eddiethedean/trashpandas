...
class MetadataCorruptedError(MetadataError):
    ...
    def __init__(self, table_name: str, details: Optional[str] = None) -> None:
        """Initialize the exception.
...
class ConnectionError(StorageError):
    ...
    def __init__(self, storage_type: str, details: Optional[str] = None) -> None:
        """Initialize the exception.
...
class ConversionError(TrashPandasError):
    ...
    def __init__(self, source_format: str, target_format: str, details: Optional[str] = None) -> None:
        """Initialize the exception.
